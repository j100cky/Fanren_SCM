...
[CreateAssetMenu(menuName = "Data/Skill Action/Shoot things")]
public class SkillAction_ShootThings : ToolAction
{
	[SerializeField] List<EnemyType> canHitNodesOfType;
	public float damage; //The damage this skill makes.//
	Quaternion rotation;

	public override void OnSkillUsed() //hit each enemy individually with individual skill effect//
	{
