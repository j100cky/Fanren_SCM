...
[CreateAssetMenu(menuName = "Data/Skill Action/Water walk")]
public class SkillAction_WaterWalk : ToolAction
{
    ...
    public override void OnSkillUsed()
    {
        ...
        if (result == null)
        {
            ...
            go.GetComponent<SkillController>().SetBuffName(buffName);
        ...
        {
            result.GetComponent<WaterWalkSkillScript>().ResetSpeed();
