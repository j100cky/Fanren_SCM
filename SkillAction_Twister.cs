...
[CreateAssetMenu(menuName = "Data/Skill Action/Twister")]
public class SkillAction_Twister : ToolAction
{
    ...
    //[SerializeField] int skillAttackSize; //The attack box radius that the mouse will use to determine the closest enemy. Should be very small. 
    ...
    public override void OnSkillUsed()
    {
        ...
        else
        {
            ...
            go.GetComponent<TwisterSkillScript>().SetTarget(collider.gameObject);
        }
